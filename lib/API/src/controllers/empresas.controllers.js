...
export const cargarInformacion = async (req, res) => {
    try {
        ...
        const createUserQuery = 'INSERT INTO pruebas (nombreempresa, imagenempresa) VALUES ($1, $2) RETURNING *';
        const result = await pool.query(createUserQuery, [nombreempresa, imagenUrl]);
